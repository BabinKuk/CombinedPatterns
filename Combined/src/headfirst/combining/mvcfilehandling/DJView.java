 ...
 * mvc pattern
 * view class 
 * observer for both real time beats and bpm changes (must implement beatobserver and bpmobserver)
 */
...
public class DJView implements ActionListener, BPMObserver {
	...
	//reference to filehandling intertace
	IFileHandler fileHandler = new FileHandling();
    ...
    JMenuItem zipMenuItem;
    JMenuItem unzipMenuItem;
    
    ArrayList cardList = new ArrayList();

	public DJView(IControllerInterface controller, IBeatModelInterface model) {
	...
	public void createControls() {
		...
		zipMenuItem = new JMenuItem("Zip");
		unzipMenuItem = new JMenuItem("Unzip");
        ...
        saveMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
            	//save file
            	fileHandler.saveFile(bpmOutputLabel.getText());
            }
        });
        ...
        zipMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
            	//zip file
            	fileHandler.zipFile(bpmOutputLabel.getText());
            }
        });
        
        unzipMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
            	//unzip file
